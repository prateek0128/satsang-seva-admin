...
const SearchBox = ({ className = "" }) => {
  ...
  return (
    <div
      className={`w-[1200px] shadow-[0px_12px_60px_rgba(61,_55,_241,_0.25)] rounded-xl bg-darkorange-200 flex flex-row flex-wrap items-start justify-start py-[40px] px-14 box-border gap-[80px] min-h-[160px] max-w-full cursor-pointer z-[2] text-left text-base text-white font-dm-sans lg:gap-[40px] lg:pl-8 lg:pr-8 lg:box-border mq750:gap-[20px] ${className}`}
