          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[4.6px] max-w-full">
            ...
            <div className="self-stretch flex flex-row items-start justify-start py-0 pr-0 pl-1 box-border max-w-full text-sm text-white font-montserrat">
              <div className="flex-1 relative leading-[160%] inline-block max-w-full z-[1]">
                Satsang Seva connects you with a variety of religious and
                spiritual events, guiding you on your spiritual journey through
                Ramayan recitations, Bhajan Sandhyas, and more. Join us to
                experience the power of spirituality that brings
                people together.
              </div>
            </div>
          </div>
          <div className="flex flex-row items-center justify-center gap-[15.7px]">
            <a className="text-white" href="tel:+91-7737237335">
              <Contact fontSize="large" />
            </a>
            <a className="text-white" href="mailto:info@satsangseva.com">
              <Mail fontSize="large" />
            </a>
            <a
            ...
            <a href="http://x.com" target="_blank" rel="noopener noreferrer">
              <X sx={{ color: "#fff", fontSize: "1.7rem" }} />
            </a>
          </div>
        </div>
          ...
          <div className="self-stretch flex flex-row items-start justify-around gap-[20px]">
            <div className="flex flex-col items-start justify-start gap-[23px]">
              ...
              <div className="relative text-sm leading-[200%] font-medium text-white z-[1]">
                ...
                <p className="m-0">
                  <Link className="text-white no-underline" to="/search-bar">
                    Online Events
                  </Link>
                </p>
              </div>
            ...
            <div className="flex flex-col items-start justify-start gap-[23px]">
              ...
              <div className="relative text-sm leading-[200%] font-medium text-white z-[1]">
                <p className="m-0">
                  <Link className="text-white no-underline" to="/aboutus">
                    About Us
                  </Link>
                </p>
                <p className="m-0">
        ...
        <div className="w-[364px] flex flex-col items-start justify-start pt-4 px-0 pb-0 box-border max-w-full">
          <div className="self-stretch flex flex-col items-start justify-start gap-[21.5px] max-w-full shrink-0">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="self-stretch no-underline rounded-[45.59px] bg-white box-border flex flex-row items-center justify-center max-w-full [row-gap:20px] z-[1] text-smi-2 text-darkgray-300 border-[2px] border-solid border-whitesmoke-300 mq450:flex-wrap mq450:box-border"
            >
