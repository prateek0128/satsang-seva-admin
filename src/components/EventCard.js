...
const EventCard = ({
  ...
  const handleClick = () => {
    ...
    navigate(`/event/${event._id}`, { state: { event: event } });
  };
  ...
  return (
    ...
    >
      <img
        ...
        src={eventCardImage}
      />
      {lastedited && <div className="text-xs p-1 z-10">
      ...
      <div className="self-stretch relative flex flex-col items-end justify-start relative">
        {map && (
          <span
            style={{ zIndex: "1", color: "#D26600" }}
            className="absolute text-sm fw-bold pr-2"
          >
            {event.dist} away
            {/* , {event.time} */}
          </span>
          ...
          <div className="w-[26.6px] flex flex-col items-start justify-start pt-[1.9px] px-0 pb-0 box-border">
            <div className="self-stretch flex flex-col items-start justify-start">
              <div className="self-stretch flex flex-row items-start justify-start py-0 pr-0 pl-px">
                <b
                  style={{ fontSize: "1rem" }}
                  className="flex-1 relative inline-block min-w-[25.6px] shrink-0 z-[1]"
                >
