    ...
    const fetchData = async () => {
      try {
        ...
        try {
          ...
          console.error("Events fetch error:", ee);
        }
      } catch (e) {
      ...
      <div style={S.grid}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          <div style={S.card}>
            <div style={S.profileSection}>
              ...
              <h2 style={{ ...S.name, marginBottom: "8px" }}>
                {user.name || "N/A"}
              </h2>
          ...
          {!isParticipant && (
            <div style={S.card}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "12px" }}>
                {user.socialLinks &&
                Object.entries(user.socialLinks).some(([_, link]) => link) ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div style={S.card}>
            ...
            >
              <h3
                style={{ ...S.sectionTitle, borderBottom: "none", margin: 0 }}
              >
                Address Detail
              </h3>
              {address.address1 && (
                <a
                  href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${address.address1} ${address.city} ${address.state} ${address.pincode}`)}`}
                  target="_blank"
                  rel="noreferrer"
                  style={{
                    fontSize: "0.75rem",
                ...
                >
                  {user.lat && user.lng
                    ...
                    : user.geoCoordinates?.coordinates
                      ? `${user.geoCoordinates.coordinates[1]}, ${user.geoCoordinates.coordinates[0]}`
                      : "—"}
                </div>
              </div>
            </div>
