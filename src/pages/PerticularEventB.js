...
const PerticularEventB = () => {
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start gap-[130px] leading-[normal] tracking-[normal] mq450:gap-[32px] mq750:gap-[65px]">
      <ButtonComponent />
      <FrameComponent2 />
      <footer className="self-stretch bg-darkorange-100 flex flex-col items-center justify-start pt-11 px-5 pb-[17px] box-border relative gap-[69px] max-w-full text-left text-lg text-white font-dm-sans mq450:gap-[17px] mq450:pt-[29px] mq450:pb-5 mq450:box-border mq750:gap-[34px]">
        <div className="w-[1440px] h-[430px] relative bg-darkorange-100 hidden max-w-full z-[0]" />
        <div className="w-[1240px] flex flex-row items-start justify-between max-w-full gap-[20px] mq1100:flex-wrap mq1100:justify-center">
                ...
                <div className="w-[34.4px] flex flex-col items-start justify-start pt-3 px-0 pb-0 box-border">
                  <div className="self-stretch h-[34.4px] overflow-hidden shrink-0 flex flex-row items-start justify-start pt-[15px] pb-0 pr-0 pl-7 box-border gap-[4px] z-[1]">
                    ...
                    <div className="h-[19.4px] w-[170.9px] flex flex-col items-start justify-start pt-px px-0 pb-0 box-border shrink-0">
                      <div className="self-stretch h-[43.5px] relative inline-block shrink-0 mq450:text-xl mq1025:text-8xl">
                        SatsangSeva
                      </div>
                    </div>
                  </div>
                </div>
                <div className="flex-1 relative leading-[43.5px] shrink-0 z-[1] mq450:text-xl mq1025:text-8xl">
                  SatsangSeva
                </div>
              </div>
...
export default PerticularEventB;
