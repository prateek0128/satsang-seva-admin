...
const CategoriesPage = () => {
  return (
    <div
      ...
      className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal] mq450:gap-[24px] mq750:gap-[48px]"
    >
      {/* Navbar section */}
      ...
      <section
        id="main"
        className="pt-5 self-stretch flex flex-row items-start justify-center box-border max-w-full"
      >
        <HostingContent />
      </section>
      <Footer
