...
const S = {
  ...
  iconBtn: (color) => ({ background: "none", border: "none", cursor: "pointer", padding: "6px 10px", borderRadius: 7, display: "inline-flex", alignItems: "center", gap: 5, fontSize: "0.72rem", fontWeight: 600, color, transition: "all 0.15s" }),
};
                    ...
                    <tr key={event._id}
                      ...
                      <td style={{ ...S.td, whiteSpace: "nowrap" }}>
                        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                          <button style={{ ...S.iconBtn("#64748b"), padding: "5px" }} title="View" onClick={() => window.open(`${process.env.REACT_APP_FRONTEND}/event/${event._id}`, "_blank")}
                            onMouseEnter={e => e.currentTarget.style.background = "#f1f5f9"} onMouseLeave={e => e.currentTarget.style.background = "transparent"}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                          </button>
                          <button style={{ ...S.iconBtn("#64748b"), padding: "5px" }} title="Edit" onClick={() => navigate(`/admin/updateevent/${event._id}`)}
                            onMouseEnter={e => e.currentTarget.style.background = "#f1f5f9"} onMouseLeave={e => e.currentTarget.style.background = "transparent"}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                          </button>
                          <button onClick={() => handleApproveEvent(event)}
                            style={{ padding: "5px 10px", borderRadius: 7, border: "1px solid #bbf7d0", background: "#f0fdf4", color: "#059669", fontSize: "0.72rem", fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", gap: 4 }}
                          ...
                          <button onClick={() => handleRejectEvent(event)}
                            style={{ padding: "5px 10px", borderRadius: 7, border: "1px solid #fecaca", background: "#fef2f2", color: "#dc2626", fontSize: "0.72rem", fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", gap: 4 }}
                          ...
                          <button style={{ ...S.iconBtn("#64748b"), padding: "5px" }} title="Delete" onClick={() => handleDeleteEvent(event)}
                    ...
                    <tr key={host._id}
                      ...
                      <td style={{ ...S.td, whiteSpace: "nowrap" }}>
                        <div style={{ display: "flex", gap: 6 }}>
                          ...
                          <button onClick={() => handleApproveHost(host)}
                          ...
                          <button onClick={() => handleRejectHost(host)}
