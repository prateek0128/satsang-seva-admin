...
const AdminPage = () => {
  ...
  const sendNotification = async () => {
    if (!notifTitle.trim() || !notifBody.trim()) {
      toast("Fill both title and message", "warning");
      return;
    }
    setSending(true);
    try {
  ...
  const actions = [
    {
      label: "Approvals",
      desc: "Review and approve pending events and hosts",
      icon: <CheckIcon />,
      color: "#059669",
      path: "/admin/approvals",
    },
    ...
    {
      label: "Events",
      desc: "Browse and manage all events",
      icon: <EventMgmtIcon />,
      color: "#D26600",
      path: "/admin/events",
    },
    ...
    },
    {
      ...
      desc: "View and manage all user bookings",
      icon: <BookingIcon />,
      color: "#d97706",
      path: "/admin/bookings",
    },
    {
      ...
      desc: "Track all sent notifications",
      icon: <PendingIcon />,
      color: "#6366f1",
          ...
          >
            <div>
              ...
              <input
                ...
                onFocus={(e) => {
                  e.target.style.borderColor = "#D26600";
                  e.target.style.background = "#fff";
                  e.target.style.boxShadow = "0 0 0 3px rgba(210,102,0,0.08)";
                }}
                onBlur={(e) => {
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!sending) e.currentTarget.style.background = "#b85a00";
              }}
              onMouseLeave={(e) => {
                if (!sending) e.currentTarget.style.background = "#D26600";
              }}
            >
