    ...
    <div style={S.container}>
      <div style={S.header}>
        <div style={{ flex: 1, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <button onClick={() => navigate(`/admin/updateuser/${id}`)}
            style={{ background: "#D26600", color: "#fff", border: "none", padding: "8px 20px", borderRadius: "8px", fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <div style={S.card}>
            <div style={S.profileSection}>
              ...
              <div style={{ marginBottom: "8px" }}>
                <span style={{ fontFamily: "monospace", fontSize: "0.85rem", color: "#64748b", fontWeight: 700, background: "#f1f5f9", padding: "2px 8px", borderRadius: "6px" }}>
