...
const S = {
  ...
  th: { padding: "14px 16px", background: "#f8fafc", borderBottom: "1px solid #e2e8f0", fontSize: "0.7rem", fontWeight: 700, color: "#64748b", textTransform: "uppercase", letterSpacing: "0.05em", textAlign: "left" },
  td: { padding: "16px", borderBottom: "1px solid #f1f5f9", fontSize: "0.875rem", color: "#334155", verticalAlign: "middle" },
